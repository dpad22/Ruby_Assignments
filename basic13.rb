...
puts (1..255).to_a.select{|elem| elem.odd?}
...
# (1..255).each {|i| puts "New number: #{i} Sum: #{}"}
...
arr.each {|i| sum += i}
avg = sum / arr.length
puts "The Max num is "+arr.max.to_s,"The Min num is "+ arr.min.to_s, "The Avg num is " + avg.to_s
